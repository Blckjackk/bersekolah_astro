...
export default function DokumenPendukungPage() {
  ...
  return (
    <div className="px-4 py-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      {/* Header */}
      <div className="mb-6">
        <h1 className="mb-2 text-xl font-bold sm:text-2xl">Dokumen Pendukung</h1>
      ...
      <Alert className="mb-6 bg-blue-50 border-blue-200">
        ...
        <AlertDescription className="text-blue-700">
          ...
          <ol className="mt-2 ml-5 space-y-2 list-decimal text-blue-700">
            <li>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className="flex flex-col justify-center items-center py-8 text-center">
                <FileText className="mb-3 w-12 h-12 text-gray-400" />
                  ...
                  >
                    {(selectedFile || selectedFiles.length > 0) ? (
                      ...
                      <div className="flex flex-col gap-2 items-center">
                        <Upload className="w-6 h-6 text-gray-400 sm:w-8 sm:h-8" />
              ...
              {previewDoc && (
                <div className="relative w-full h-full">
                  ...
                  {isFilePDF(previewDoc.file_name, previewDoc.file_type) ? (
                      ...
                      <div className="flex justify-center items-center p-4 min-h-full">
                        <img 
                          ...
                          onError={(e) => {
                            ...
                            fallback.className = 'flex flex-col justify-center items-center p-8 w-full h-full text-center bg-gray-50'
                            fallback.innerHTML = `
                    ...
                    <div className="flex flex-col justify-center items-center p-8 w-full h-full text-center bg-gray-50">
                      <svg className="mx-auto mb-4 w-16 h-16 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
