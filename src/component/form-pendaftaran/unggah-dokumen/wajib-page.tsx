...
export default function DokumenWajibPage() {
  ...
  const getDocumentStatus = (docCode: string): UploadedDocument | undefined => {
    ...
    if (foundDoc) {
      ...
      console.log('Document not found. Available docs:', uploadedDocs.map(doc => ({
        id: doc.id,
  ...
  const getUploadedDocuments = () => {
    ...
    const mappedDocuments = documentTypes.map(docType => {
      ...
      if (uploadedDoc) {
        console.log('Uploaded doc found:', {
          id: uploadedDoc.id,
        ...
        console.log('No uploaded doc found for type:', docType.code);
      }
  ...
  return (
    <div className="container px-4 py-4 mx-auto space-y-6 sm:px-6 lg:px-8">
      {/* Header */}
      <div className="mb-6">
        <h1 className="mb-2 text-xl font-bold sm:text-2xl">Dokumen Wajib</h1>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <div className="flex gap-2 items-center">
                ...
                >
                  {completedDocs === totalDocs ? (
                    <><CheckCircle2 className="mr-1 w-3 h-3" /> Selesai</>
                  ) : (
                    <><FileText className="mr-1 w-3 h-3" /> {completedDocs}/{totalDocs}</>
                  )}
                </Badge>
                        ...
                        <div className="flex justify-between items-start">
                          <div className="flex gap-2 items-center min-w-0">
                            ...
                            <div className="min-w-0">
                              ...
                              {doc.is_required && (
                                <Badge variant="secondary" className="mt-1 text-xs">Wajib</Badge>
                              )}
                            </div>
                          </div>
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            {getDocumentStatus(activeDocument?.code || '') && (
              <div className="p-3 mt-2 bg-yellow-50 rounded-md border border-yellow-200">
            ...
            {previewDoc && (
              <DialogDescription>
                ...
                {previewDoc.keterangan && (
                  <div className="p-2 mt-2 text-sm bg-gray-50 rounded-md border">
                  ...
                  <img 
                    ...
                    onError={(e) => {
                      ...
                      if (parent) {
                        ...
                        fallback.className = 'flex flex-col justify-center items-center p-8 text-center'
                        fallback.innerHTML = `
                          <svg class="mb-4 w-16 h-16 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                          </svg>
                          <h3 class="mb-2 text-lg font-medium text-gray-900">Gambar tidak dapat ditampilkan</h3>
                          <p class="mb-4 text-gray-500">File gambar tidak dapat ditampilkan dalam preview. Silakan buka di tab baru untuk melihat gambar.</p>
                        `
