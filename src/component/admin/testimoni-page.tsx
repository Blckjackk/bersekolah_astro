                      ...
                      <div className="overflow-hidden relative w-10 h-10 rounded-full">
                        <img 
                          src={
                            ...
                            || (item.foto_testimoni ? `https://api.bersekolah.com/storage/testimoni/${item.foto_testimoni}` : 'https://api.bersekolah.com/storage/defaults/testimoni-default.jpg')
                          }
                          alt={item.nama}
                          className="object-cover w-full h-full"
                          onError={(e) => {
                            const target = e.target as HTMLImageElement;
                            target.src = 'https://api.bersekolah.com/storage/defaults/testimoni-default.jpg';
                          }}
                        />
                      </div>
                    </TableCell>
                    ...
                    <div className="overflow-hidden relative w-20 h-20 rounded-md">
                      <img
                        src={
                          ...
                          || (selectedTestimoni.foto_testimoni ? `https://api.bersekolah.com/storage/testimoni/${selectedTestimoni.foto_testimoni}` : 'https://api.bersekolah.com/storage/defaults/testimoni-default.jpg')
                        }
